...
Links labelled as **INCONSISTENT** are contact links that have been flagged for further checking by the user because the exposure window of the infectee does not overlap with the infectious period of the infector. This could be because the onset date of infector is after that of infectee or perhaps the infector died before the infectee was exposed (although this could of course be funeral transmission).
